...
export function ActivityForm({ onAddActivity, availableTags, onCreateTag }: ActivityFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (selectedTags.length === 0) {
      toast({
        ...
        description: "Adicione pelo menos uma tag para categorizar a atividade.",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleCreateNewTag = () => {
    if (newTagName.trim()) {
      ...
      toast({
        title: "Tag criada!",
        description: `Tag "${newTagName.trim()}" foi adicionada com sucesso.`,
      });
    }
  };
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="description"
                placeholder="Descreva o que você fez neste período..."
                value={description}
                ...
                {availableTags.map((tag) => (
                  ...
                  >
                    <Badge
                      ...
                      style={{ backgroundColor: selectedTags.find(t => t.id === tag.id) ? tag.color : undefined }}
                      onClick={() => 
